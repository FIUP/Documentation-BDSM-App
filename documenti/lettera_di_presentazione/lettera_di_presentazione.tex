...
\name{\includegraphics[width=8cm]{../template/images/logo/logo_verticale.pdf}}{}
...
Con la presente, il gruppo \groupName , intende comunicarle ufficialmente la partecipazione alla \textbf{Revisione di Accettazione}, per la realizzazione del prodotto da Lei commissionato, denominato \textit{BDMSApp}.
...
Il costo stimato per la realizzazione del progetto non ha subito variazioni ed è rimasto di \textbf{\EUR{ ??}}.
