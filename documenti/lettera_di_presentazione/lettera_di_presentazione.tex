...
In particolare, sono allegati:
	...
	\end{itemize}
\noindent
Viene inoltre allegato il codice sorgente del prodotto a riprova dell'avanzamento dei lavori descritto nel \textit{Piano di Progetto v7	.0.0}. Si segnala che all'indirizzo {\color{blue}\url{http://mashup-unipd.github.io}} è disponibile l'ultima versione dall'applicativo dove è possibile provare le funzionalità fin'ora implementate, previa registrazione. \\
\vfill
