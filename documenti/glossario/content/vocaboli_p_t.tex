...
\label{sec:p}
	\begin{itemize}
		...
		\item \textbf{ProjectLibre:} e un sistema di software che permette di aiutare a pianificare, organizzare e sviluppare risorse (project management software system). Funziona con la piattaforma Java ed è un free software che può essere utilizzato su Linux, Mac OS e Windows;		
