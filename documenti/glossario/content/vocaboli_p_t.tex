...
\label{sec:r}
	\begin{itemize}
		...
		\item \textbf{Recipe:} 	ricetta in italiano. Una recipe è composta da una serie di parametri predefiniti e viene utilizzata per interrogare i social network periodicamente ottenendo dei risultati da utilizzare nelle view;
