...
\newcommand{\docVersionAdR}{\emph{v2.0.0}} % Analisi dei Requisiti
\newcommand{\docVersionGlo}{\emph{v2.0.0}} % Glossario
\newcommand{\docVersionNdP}{\emph{v2.0.0}} % Norme di Progetto
\newcommand{\docVersionPdP}{\emph{v2.0.0}} % Piano di Progetto
