...
\newcommand{\docVersionAdR}{\emph{v3.0.0}} % Analisi dei Requisiti
\newcommand{\docVersionGlo}{\emph{v3.0.0}} % Glossario
\newcommand{\docVersionNdP}{\emph{v3.0.0}} % Norme di Progetto
\newcommand{\docVersionPdP}{\emph{v3.0.0}} % Piano di Progetto
\newcommand{\docVersionPdQ}{\emph{v2.0.0}} % Piano di Qualifica
