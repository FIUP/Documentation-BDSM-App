...
\newcommand{\docVersionNdP}{\emph{v4.0.0}} % Norme di Progetto
\newcommand{\docVersionPdP}{\emph{v4.0.0}} % Piano di Progetto
\newcommand{\docVersionPdQ}{\emph{v3.0.0}} % Piano di Qualifica
