	...
	\paragraph{Classi} % (fold)
		...
		\label{subp:client_model_data_viewtypemodel}
			...
			\begin{itemize}
				...
				\item \textbf{Metodi}:
					\begin{itemize}
						\item \textcolor{forestgreen}{\texttt{- getViews(conf, cat, type, val, viewType)}}
						\begin{description}
							\item \textbf{Descrizione}: metodo che restituisce un array di funzioni che verranno applicate dalle classi figlie di ChartCreator per ottenere i vari tipi di grafico da generare (views) in base alla categoria e al tipo della metrica, e in base al fatto che si tratti di un grafico di confronto o meno.L'argomento conf (booleano) determina se bisogna generare un confronto, cat e type contengono la categoria e il tipo della metrica, mentre val il suo valore. Nel caso venga specificata la stringa viewType viene restituita solo la funzione relativa alla stringa passata.
							Si noti che questa classe è in realtà suddivisa in una classe base e le sei sottoclassi viewTypeFbSingleModel, viewTypeFbConfModel, viewTypeTwSingleModel, viewTypeTwConfModel, viewTypeIgSingleModel, viewTypeIgConfModel (view singole e confronti per ogni social), in quanto la classe sarebbe diventata troppo grossa per linee di codice e SLOC. Logicamente però il sistema vede queste classi come la sola classe ViewTypeModel, ragion per cui non sono state descritte singolarmente queste classi.
						\end{description}
					\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: questo attributo contiene la descrizione dei vari servizi REST pubblici dell'applicazione e ne costituisce la documentazione. Il formato dei JSON che contiene è il seguente:
								\begin{verbatim}
									{
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: identificativo dell'utente all'interno del sistema
						\end{description}
						\item \textcolor{forestgreen}{\texttt{- username : stringa}}
						\begin{description}
							\item \textbf{Descrizione}: username dell'utente
						\end{description}
						\item \textcolor{forestgreen}{\texttt{- password : stringa}}
						\begin{description}
							\item \textbf{Descrizione}: chiave di accesso dell'utente.
						\end{description}
						\item \textcolor{forestgreen}{\texttt{- permission : stringa}}
						\begin{description}
							\item \textbf{Descrizione}: descrive se l'utente è un utente normale o amministratore.
						\end{description}
						\item \textcolor{forestgreen}{\texttt{- email : stringa}}
						\begin{description}
							\item \textbf{Descrizione}: l'indirizzo email dell'utente.
						\end{description}
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: identificativo della Recipe all'interno del sistema
						\end{description}
						\item \textcolor{forestgreen}{\texttt{- title : stringa}}
						\begin{description}
							\item \textbf{Descrizione}: nome della Recipe
						\end{description}
						\item \textcolor{forestgreen}{\texttt{- desc : stringa}}
						\begin{description}
							\item \textbf{Descrizione}: descrizione del contenuto della Recipe.
						\end{description}
						\item \textcolor{forestgreen}{\texttt{- metrics : array di oggetti JSON nella forma descritta da MetricModel}}
						\begin{description}
							\item \textbf{Descrizione}: la lista delle metriche che fanno parte della recipe.
						\end{description}
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: identificativo dell'utente che invia la richiesta.
						\end{description}
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: identificativo dell'amministratore che aggiunge la richiesta.
						\end{description}
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: social network al quale la metrica si riferisce
						\end{description}
						...
						\begin{description}
							\item \textbf{Descrizione}: valore della metrica.
						\end{description}
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						\item \textcolor{forestgreen}{\texttt{- metrics : array di oggetti JSON nella forma descritta da MetricModel}}
						\begin{description}
							\item \textbf{Descrizione}: la lista delle metriche che fanno parte del confronto.
						\end{description}
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
