			...
			\begin{itemize}
				...
				\item \textbf{Metodi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: metodo che restituisce in un oggetto JSON i vari tipi di grafico da generare (views) in base alla categoria e al tipo della metrica, e in base al fatto che si tratti di un grafico di confronto o meno.
						\end{description}
					\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: questo attributo contiene la descrizione dei vari servizi REST pubblici dell'applicazione e ne costituisce la documentazione.
						\end{description}
					\end{itemize}
...
%Non c'è più distinzione tra utenti normali e amministratori a livello di attributi.	
\begin{comment}
