			...
			\begin{itemize}
				...
				\item \textbf{Metodi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: metodo che restituisce in un array di oggetti JSON i vari tipi di grafico da generare (views) in base alla categoria e al tipo della metrica, e in base al fatto che si tratti di un grafico di confronto o meno. L'argomento conf (booleano) determina se bisogna generare un confronto, cat e type contengono la categoria e il tipo della metrica, mentre val il suo valore. Il formato dei JSON restituiti è il seguente:
								\begin{verbatim}
									{
									    kind: 'line',
                                    	time: 'weekly',
