	...
	\paragraph{Classi} % (fold)
		...
		\label{subp:bdsm_app_client_controller_public_publicrouteconfig}
			\begin{figure}[htbp]
				...
				\caption{Classe - client::controller::public::PublicRoute}
			\end{figure}
		\begin{itemize}
	...
	\paragraph{Classi} % (fold)
		...
		\label{subp:client_controller_user_menuctrl}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller:user::MenuCtrl}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:client_controller_user_menumainctrl}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller:user::MenuMainCtrl}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:client_controller_user_menusecondctrl}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller:user::MenuSecondCtrl}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_controller_user_homerouteconfig}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller:user::HomeRoute}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_controller_user_reciperouteconfig}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller:user::RecipeRoute}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_controller_user_reciperequestrouteconfig}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller:user::RecipeRequestRoute}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_controller_user_tokenconfigroute}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller:user::TokenConfigRoute}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_controller_user_logoutctrl}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller:user::LogoutCtrl}
			\end{figure}
			\begin{itemize}
	...
	\paragraph{Classi} % (fold)
		...
		\label{subp:bdsm_app_client_controller_admin_menusecondadminctrl}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller::admin::MenuSecondAdminCtrl}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_controller_admin_recipeconfigroute}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller::admin::RecipeConfigRoute}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_controller_admin_recipelistroute}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller::admin::RequestListRoute}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_controller_admin_userconfigroute}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::controller::admin::UserConfigRoute}
			\end{figure}
			\begin{itemize}
