	...
	\paragraph{Classi} % (fold)
		...
		\label{subp:client_model_services_authservice}
			\begin{figure}[htbp]
				...
				\caption{Classe - client::model::services::AuthServiceTarget}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:client_model_services_authservice}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::model::services::AuthServiceAdapter}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:client_model_services_recipeservice}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::model::services::RecipeService}
			\end{figure}
			\begin{itemize}
				\item \textbf{Descrizione}: p la classe che racchiude i metodi per reperire i dati relativi alle Recipe, siano essi salvati in locale o da recuperare dal server, inoltre gestisce l'invio di richieste di Recipe al server;
		...
		\label{subp:client_model_services_recipeadminservice}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::model::services::RecipeAdminService}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:client_model_services_useradminservice}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::model::services::UserAdminService}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:chartcreator}
			...
			\begin{itemize}
				...
				\item \textbf{Metodi}: 
					\begin{itemize}
						\item protected templateCreazioneGrafico() : JSONObject
						\item protected formattaDati() : JSONObject
					\end{itemize}
			\end{itemize}
		...
		\label{subp:radarchartcreator}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::model::services::ManagerDataExpirationDate}
			\end{figure}
			\begin{itemize}
