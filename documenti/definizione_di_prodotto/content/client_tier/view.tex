	...
	\paragraph{Classi} % (fold)
		...
		\label{subp:bdsm_app_client_view_public_login}
			\begin{figure}[htbp]
				...
				\caption{Classe - client::view::public::Login}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_public_about}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::public::About}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_public_register}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::public::Register}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_public_apidocs}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::public::ApiDocs}
			\end{figure}
			\begin{itemize}
	...
	\paragraph{Classi} % (fold)
		...
		\label{subp:bdsm_app_client_view_user_home}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::Home}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_recipe}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::Recipe}
			\end{figure}		
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_metrics}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::Metrics}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_charts}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::Charts}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_compare}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::Compare}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_reciperequest}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::RecipeRequest}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_favourites}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::Favourites}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_tokenconfig}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::TokenConfig}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_settings}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::Settings}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_menu}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::Menu}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_menumain}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::MenuMain}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_user_menusecond}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::user::MenuSecond}
			\end{figure}
			\begin{itemize}
	...
	\paragraph{Classi} % (fold)
		...
		\label{subp:bdsm_app_client_view_admin_recipeconfig}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::admin::RecipeConfig}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_admin_requestlist}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::admin::RequestList}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_admin_insert}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::admin::Insert}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_admin_ratings}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::admin::Ratings}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_admin_usersconfig}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::admin::UsersConfig}
			\end{figure}
			\begin{itemize}
		...
		\label{subp:bdsm_app_client_view_admin_menusecondadmin}
			\begin{figure}[htbp]
				\centering
				\centerline{\includegraphics[scale=0.7]{./images/client/classes/example_class.png}}
				\caption{Classe - client::view::admin::MenuSecondAdmin}
			\end{figure}
			\begin{itemize}
