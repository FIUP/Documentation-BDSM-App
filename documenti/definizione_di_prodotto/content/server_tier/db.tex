	...
	\paragraph{Classi} % (fold)
		...
		\paragraph{Classi} % (fold)
			...
			\label{subp:server_db_raw_data_fb_rawfbpage}
				\begin{itemize}
					...
					\item \textbf{Attributi}:
					\begin{itemize}
						\item name_str : String
						\item category_str : String
					\end{itemize}
					\item \textbf{Metodi}: N/A
				\end{itemize}
			...
			\label{subp:server_db_raw_data_fb_rowfbeventtrend}
				\begin{itemize}
					...
					\item \textbf{Attributi}: 
					\begin{itemize}
						\item invited_int : int
						\item attending_int : int
						\item declined_int : int
						\item maybe_int : int
					\end{itemize}
					\item \textbf{Metodi}: N/A
				\end{itemize}
			...
			\label{subp:server_db_raw_data_fb_rawfbpost}
				\begin{itemize}
					...
					\begin{itemize}
						\item date_created_date : Date
						\item posts_int : int
						\item comments_int : int
						\item admin_posts_int : int
						\item admin_comments_int : int
						\item posts_like_int : int
						\item comments_like_int : int
					\end{itemize}
					\item \textbf{Metodi}: N/A
				\end{itemize}
		...
		\label{subp:server_db_raw_data_tw_rawtwuser}
			\begin{itemize}
				...
				\item \textbf{Attributi}: 
					\begin{itemize}
						\item full_name_str : String
						\item photo_url_str : String
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
		...
		\label{subp:server_db_raw_data_tw_rawigusertrend}
			\begin{itemize}
				...
				\item \textbf{Attributi}: 
					\begin{itemize}
						\item favourites_count_int : int
						\item followers_count_int : int
						\item friends_count_int : int
						\item sattuses_count_int : int
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
		...
		\label{subp:server_db_raw_data_tw_rawtwusertweet}
			\begin{itemize}
				...
				\item \textbf{Attributi}: 
					\begin{itemize}
						\item source_devices_list : List
						\item favourites_count_int : int
						\item media_count_int : int
						\item retweets_count_int : int
						\item tweets_count_int : int
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
		...
		\label{subp:server_db_raw_data_ig_rawigusertrend}
			\begin{itemize}
				...
				\item \textbf{Attributi}:  
					\begin{itemize}
						\item media_int : int
						\item followed_by_int : int
						\item follows_int : int
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:  
					\begin{itemize}
						...
						\item comments_int : int
						\item likes_int : int
						\item photos_count_int : int
						\item videos_count_int : int
						\item location_obj : List
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
