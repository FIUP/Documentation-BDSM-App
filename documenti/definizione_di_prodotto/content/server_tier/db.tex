			...
			\label{subp:server_db_raw_data_fb_RawFbPostTrend}
				...
				\begin{itemize}
					...
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: numero totate di commenti ai post della pagina o dell'evento.
						\end{description}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: numero totale dei preferiti ai tweets di utente Twitter.
						\end{description}
						...
						\begin{description}
							\item \textbf{Descrizione}: numero dei TO DO di un utente Twitter.
						\end{description}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\item \textcolor{forestgreen}{\texttt{+ favourites\_count\_int : int}}
						\begin{description}
							\item \textbf{Descrizione}: totale dei preferiti dei tweets di TO DO
						\end{description}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\item \textcolor{forestgreen}{\texttt{+ tweets\_count\_int : int}}
						\begin{description}
							\item \textbf{Descrizione}: totale dei tweet contentente un determinato hashtag.
						\end{description}
					\end{itemize}
				\item \textbf{Metodi}: N/A
			\end{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{Attributi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: numero di followed dell'utente su Intagram.
						\end{description}
