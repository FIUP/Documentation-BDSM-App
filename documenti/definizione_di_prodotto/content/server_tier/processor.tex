  ...
  \paragraph{Classi} % (fold)
    ...
    \begin{itemize}
      ...
      \item \textbf{Relazioni con altre classi}:
		...
		\item \textbf{Attributi}:
        	\begin{itemize}
          		\item istance\_obj : RequestHandler
        	\end{itemize} 
		\item \textbf{Metodi}: 
        	\begin{itemize}
         		 \item private RequestHandler() 
         		 \item public dispatch\_request() : Dictionary
         		 \item public get\_istance() : RequestHandler
        	\end{itemize}
      \end{itemize}
    ...
    \begin{itemize}
      ...
      \item \textbf{Relazioni con altre classi}:
		...
		\item \textbf{Metodi}: 
        	\begin{itemize}
          		\item public dispatch() : Dictionary
        	\end{itemize}
      \end{itemize}
    ...
    \begin{itemize}
      ...
      \item \textbf{Relazioni con altre classi}:
		...
		\item \textbf{Attributi}: 
        	\begin{itemize}
          		\item miner\_obj : MinerScheduler
        	\end{itemize}
		\item \textbf{Metodi}: 
        	\begin{itemize}
          		\item public update\_recipe() : void
        	\end{itemize}
    \end{itemize}
    ...
    \end{itemize}
      ...
      \begin{itemize}
		...
		\item \textbf{Metodi}: 
        	\begin{itemize}
          		\item public execute() : Dictionary
        	\end{itemize}
      \end{itemize}
