		...
		\item \textbf{Metodi}:
        	\begin{itemize}
         		 \item private RequestHandler()
							\begin{description}
								\item \textbf{Descrizione}: construttore privato del singleton RequestHandler.
							\end{description}
         		 \item public dispatch\_request(request_name: String, request_args: Dictionary) : Dictionary
							...
							\end{description}
         		 \item public static get\_istance() : RequestHandler
							\begin{description}
		...
		\item \textbf{Metodi}:
        	\begin{itemize}
          		\item public dispatch(request_name: String, request: Dictionary) : Dictionary
							\begin{description}
								\item \textbf{Descrizione}: metodo che si occupa di far confluire un determinata richiesta (ed i dati associati mappati in un dizionario) ad un determinato comando grazie all'attributo \texttt{commands_dict}. Ritorna la risposta alla chiamata tramite un dizionario.
							\end{description}
        	\end{itemize}
      \end{itemize}
		...
		\item \textbf{Metodi}:
        	\begin{itemize}
          		\item public static get() : void
							\begin{description}
								\item \textbf{Descrizione}: metodo definito secondo gli standard della Google cloud Platform. Si occupa di ricavare le Recipe scadute per fornirle alla classe \texttt{MinerScheduler} che procederà all'aggiornamento dei dati di ogni singola metrica.
							\end{description}
        	\end{itemize}
    \end{itemize}
