...
\paragraph{Classi} % (fold)
			...
			\begin{itemize}
				...
				\item \textbf{Metodi}:
					\begin{itemize}
						...
						\end{description}
						\item \textcolor{forestgreen}{\texttt{+ static update\_ig\_metrics(recipe\_id : String) : void}}
						\begin{description}
							\item \textbf{Descrizione}: il metodo controlla il tipo di recipe e avvia l'aggiornamento della recipe di Instagram;
						\end{description}
						\item \textcolor{forestgreen}{\texttt{+ static update\_tw\_metrics(recipe\_id : String) : void}}
						\begin{description}
			...
			\begin{itemize}
				...
				\item \textbf{Metodi}:
					\begin{itemize}
						...
						\begin{description}
							\item \textbf{Descrizione}: il metodo in questa classe viene solamente marcato come astratto, verrà implementato successivamente nelle classi figlie. Il metodo viene utilizzato in ogni elemento iterato;
						\end{description}
		...
		\label{subp:server_miner_SocialAuth}
			...
			\end{figure}
				\begin{itemize}
				\item \textbf{Descrizione}: classe che rappresenta la fase di autenticazione dei social network. Essendo una classe di utilità, essa fornisce dei metodi statici per ottenere facilmente i dati relativi ai permessi da utilizzare per le API dei vari social network.
		...
		\label{subp:server_miner_GeocodeHelper}
				...
				\end{figure}
				\begin{itemize}
				\item \textbf{Descrizione}: classe che si occupa di convertire la geolocalizzazione da una località a coordinate geografiche. Essa è stata implementata utilizzando metodi statici in quanto essendo un metodo di utilità, non presenta la necessità di interagire con l'istanza della classe.
			...
			\begin{itemize}
				...
				\item \textbf{Metodi}:
					\begin{itemize}
						...
						\item \textcolor{forestgreen}{\texttt{+ get\_trend\_data() : void}}
						\begin{description}
							\item \textbf{Descrizione}: il metodo tramite le chiamate alle API di Instagram recupera i dati di trend dell'hashtag. Effettua le opportune chiamate per l'aggregazione dei dati e aggiunge i dati come figli all'oggeto hashtag\_obj creato precedentemente;
						\end{description}
					\end{itemize}
			\end{itemize}
