...
\begin{small}
	...
	\label{tab:history}
		...
		% Fase di Progettazione di Dettagglio - Requisiti opzionali - RA

		% Fase di Progettazione di Dettaglio - Requisiti desiderbaili - RA
		v3.0.4 & 2015-06-09 & \emph{Aggiornata descrizione e diagrammi classi package server::processor} &
		\begin{tabular}[c]{c c}
			Cusinato Giacomo \\
			\emph{Progettista} \\
		\end{tabular} \\
		...
		% Fase di Consolidamento progettazione e codifica dei requisiti desiderabili - RQ
		...
		% Fase di Progettazione di Dettaglio - Requisiti obbligatori - RQ
