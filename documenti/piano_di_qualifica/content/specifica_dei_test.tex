	...
	\subsection{Test di unità}
		\subsubsection{Descrizione dei test di unità}
			...
			\begin{longtable}{| p{2cm} | p{8cm} | p{2.5cm} |}
					...
					\hline						
					TU1 & Viene verificato che vengano estratti correttamente tutti i dati di una pagina Facebook. & N.I.\\
					\hline
					TU2 & Viene verificato che vengano estratti correttamente tutti i dati di un evento Facebook. & N.I.\\
					\hline
					TU3 & Viene verificato che vengano estratti correttamente tutti i dati dei trend relativi ad una pagina Facebook. & N.I.\\
					\hline
					TU4 & Viene verificato che vengano estratti correttamente tutti i dati dei post relativi ad una pagina Facebook. & N.I.\\
					\hline
					TU5 & Viene verificato che vengano estratti correttamente tutti i dati dei trend relativi ad un evento Facebook. & N.I.\\
					\hline
					TU6 & Viene verificato che vengano estratti correttamente tutti i dati dei post relativi ad un evento Facebook. & N.I.\\
					\hline
					TU7 & Viene verificato che vengano estratti correttamente tutti i dati di un utente di Twitter. & N.I.\\
					\hline
					TU8 & Viene verificato che vengano estratti correttamente tutti i dati dei trend di un utente di Twitter. & N.I.\\
					\hline
					TU9 & Viene verificato che vengano estratti correttamente tutti i dati dei tweet di un utente di Twitter. & N.I.\\
					\hline
					TU10 & Viene verificato che vengano estratti correttamente tutti i dati di un hashtag di Twitter. & N.I.\\
					\hline
					TU11 & Viene verificato che vengano estratti correttamente tutti i dati dei tweet di un hashtag di Twitter. & N.I.\\
					\hline
					TU12 & Viene verificato che vengano estratti correttamente tutti i dati di un utente di Instagram. & N.I.\\
					\hline
					TU13 & Viene verificato che vengano estratti correttamente tutti i dati dei trend di un utente di Instagram. & N.I.\\
					\hline
					TU14 & Viene verificato che vengano estratti correttamente tutti i dati dei media di un utente di Instagram. & N.I.\\
					\hline
					TU15 & Viene verificato che vengano estratti correttamente tutti i dati dei trend di un hashtag di Instagram. & N.I.\\
					\hline
					TU16 & Viene verificato che vengano estratti correttamente tutti i dati dei media di un hashtag di Instagram. & N.I.\\
					\hline
					TU17 & Viene verificato che non vengano prelevati i dati statici di una pagina di Facebook già presente nel database. & N.I.\\
					\hline
					TU18 & Viene verificato che non vengano prelevati i dati statici di una evento di Facebook già presente nel database. & N.I.\\
					\hline
					TU19 & Viene verificato che non vengano prelevati i dati statici di un utente di Twitter già presente nel database. & N.I.\\
					\hline
					TU20 & Viene verificato che non vengano prelevati i dati statici di un utente di Instagram già presente nel database. & N.I.\\
					\hline
					TU21 & Viene verificato che vengano prelevati tutti i dati delle metriche delle ricette che necessitano di essere aggiornate. & N.I.\\
					\hline
					TU22 & Viene verificato che vengano prelevati tutti i dati delle metriche delle ricette che necessitano di essere aggiornate. & N.I.\\
					\hline
					TU23 & Viene verificato il corretto funzionamento del singleton del processor. & N.I.\\
					\hline
					TU24 & Viene verificato che l'aggiunta di un nuovo utente al sistema avvenga correttamente. & N.I.\\
					\hline
					TU25 & Viene verificato che la modifica dei dati dell'utente avvenga correttamente. & N.I.\\
					\hline
					TU26 & Viene verificato che la cancellazione dell'utente dal sistema avvenga correttamente. & N.I.\\
					\hline
					TU27 & Viene verificato che il metodo restituisca i dati relativi ad un utente registrato al sistema correttamente. & N.I.\\
					\hline
					TU28 & Viene verificato che il metodo restituisca correttamente la lista di tutti gli utenti registrati al sistema. & N.I.\\
					\hline
					TU29 & Viene verificato che il metodo permetta la modifica dei permessi di un utente registrato al sistema. & N.I.\\
					\hline
					...
					\hline
					TU33 & Viene verificato che il metodo permetta l'aggiunta di una nuova Recipe nel sistema. & N.I.\\
					\hline
					TU34 & Viene verificato che il metodo permetta l'eliminazione di una Recipe presente nel sistema. & N.I.\\
					\hline
					TU35 & Viene verificato che il metodo ricavi correttamente i dati di una Recipe presente nel sistema. & N.I.\\
					\hline
					TU36 & Viene verificato che il metodo restituisca correttamente la lista di tutte le Recipe presenti nel sistema. & N.I.\\
					\hline
