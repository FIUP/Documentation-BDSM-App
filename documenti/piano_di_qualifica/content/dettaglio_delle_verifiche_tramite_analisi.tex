		...
		\begin{table}[!ht]
			\begin{center}
				\begin{tabularx}{0.9\textwidth}{|l|l|X|}
					...
					\hline			
					\docNameVersionMA & 61 & \textcolor{green}{Superato}\\
					\hline
					\docNameVersionMU & 60 & \textcolor{green}{Superato}\\		
					\hline
				\end{tabularx}
			\end{center}
		...
		\subsubsection{Metriche codice}
			...
			\begin{description}
				...
				\begin{itemize}
						\item Backend:
							\begin{itemize}
								\item Branch coverage: 84\% \textcolor{yellow}{Superato}
								\item Statements coverage: 91\% \textcolor{green}{Superato}
							\end{itemize}
						\item Client:
							\begin{itemize}
