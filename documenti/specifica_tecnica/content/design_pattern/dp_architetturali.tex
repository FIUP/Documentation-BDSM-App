...
\label{sub:design_pattern_architetturali}
	...
	\label{ssub:mvw}
		\begin{itemize}
			\item Non si tratta di un design pattern vero e proprio, ma è un modo di intendere il pattern MVC prendendo alcune caratteristiche dal pattern MVVM, cosa che permette di avere una corrispondenza più diretta e automatica tra la \emph{view} e il \emph{model}. L'acronimo MVW sta infatti per Model-View-Whatever, dove \emph{Whatever} indica \emph{``whatever works for you''};
		\end{itemize}
