...
\begin{figure}[htbp]
	\centering
	\centerline{\includegraphics[scale=1.02]{./images/client/client_model.pdf}}
...
% PACKAGE MODEL::DATA
\input{./content/client_tier/model_data} % \clearpage \newpage
% END PACKAGE MODEL::DATA

% PACKAGE MODEL::SERVICES
\input{./content/client_tier/model_services}
