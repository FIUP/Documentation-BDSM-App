...
\begin{figure}[htbp]
	\centering
	\centerline{\includegraphics[scale=0.6]{./images/server/miner.pdf}}
...
\end{itemize}
	...
	\begin{figure}[!htbp]
		\centering
		\centerline{\includegraphics[scale=0.6]{./images/server/miner_tw.pdf}}
...
\begin{figure}[htbp]
	\centering
	\centerline{\includegraphics[scale=0.6]{./images/server/miner_ig.pdf}}
