...
I diagrammi delle attività presenti in questa sezione sono stati rappresentati tramite l'uso dei diagrammi di Gantt.
	...
	Nonostante la terminazione di questa fase sia fissata in un giorno preciso, la ricerca di strumenti più efficienti e migliorativi per l'avanzamento del progetto deve essere sempre portata avanti da parte dell'\roleAdministrator.
		...
		\label{ssub:diagramma_delle_attivita}
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=14cm]{images/d_attivita_fase_implem_strumenti.pdf}
	...
	Le attività che verranno svolte sono:
		...
		\label{ssub:diagramma_delle_attivita}
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=14cm]{images/d_attivita_analisi_requisiti.pdf}
	...
	Le attività che verranno svolte sono:
		...
		\label{ssub:diagramma_delle_attivita}
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=14cm]{images/d_attivita_analisi_dettaglio.pdf}
	...
	Le attività che verranno svolte sono:
		...
		\label{ssub:diagramma_delle_attivita}
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=14cm]{images/d_attivita_prog_architetturale.pdf}
				\caption{Diagramma di Gantt - Progettazione architetturale}
				\label{fig:gantt_prog_architetturale}				
			\end{figure}
		% subsubsection diagramma_delle_attività (end)
	% subsection progettazione_architetturale (end)m
	...
	\textbf{Periodo}:  2015/04/01 - 2015/04/27 \\
	...
	Le attività che verranno svolte sono:
		...
		\label{ssub:diagramma_delle_attivita}
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=14cm]{images/d_attivita_prog_dett_cod_obbl.pdf}
	...
	Le attività che verranno svolte sono:
		...
		\label{ssub:diagramma_delle_attivita}
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=14cm]{images/d_attivita_prog_dett_cod_des.pdf}
	...
	Le attività che verranno svolte sono:
		...
		\label{ssub:diagramma_delle_attivita}
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=14cm]{images/d_attivita_prog_dett_cod_opz.pdf}
	...
	Le attività che verranno svolte sono:
		...
		\label{ssub:diagramma_delle_attivita}
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=14cm]{images/d_attivita_validazione.pdf}
