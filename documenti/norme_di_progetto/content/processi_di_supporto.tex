...
\section{Processi di Supporto}
	...
	Il processo prevede una prima fase di pianificazione e successivamente di verifica.
		...
		\label{ssub:procedure}
			...
			Ogni membro del gruppo dovrà seguire la seguente procedura per interfacciarsi con il sistema adottato di Continuous Integration configurato dall'\roleAdministrator.
				\begin{itemize}
					\item accedere al sito \url{}
					\item TODO
				\end{itemize}
