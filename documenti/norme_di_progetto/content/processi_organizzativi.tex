...
\section{Processi Organizzativi}
	...
	\subsection{Gestione dei Processi}
		\subsubsection{Attività}
			...
			Per farlo si serve dell'applicazione web Asana \\
		...
		\subsubsection{Procedure}
			...
			\paragraph{Procedura di svolgimento dei ticket assegnati}
			TO DO
				\begin{enumerate}
					\item TO DO
					\item TO DO
		...
		\subsubsection{Norme}
			...
			I ticket che si andranno ad aprire devono contenere le seguente informazioni:
				\begin{itemize}
					...
					\item \textbf{Descrizione}: qualora non fosse abbastanza esaustivo il titolo del ticket, si deve fornire una descrizione più dettagliata dell'attività da svolgere;
				...
				\end{itemize}
			\noindent
			La figura \ref{fig:template_ticket_asana} illustra come vengono rappresentate queste informazioni su Asana. Inoltre viene proprio presa da uno screenshot di un template di ticket, copiabile dal \roleProjectManager{} e modificabile una volta copiato a seconda dell'esigenze riportate in precedenza.
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=15cm]{images/template_ticket_asana.pdf}
				\caption{Template Ticket su Asana}
				\label{fig:template_ticket_asana}
			\end{figure}
			...
			Le change request che si andranno ad aprire devono contenere le seguente informazioni:
				...
				\end{itemize}
				La figura \ref{fig:template_change_request_asana} illustra come vengono rappresentate queste informazioni su Asana. Inoltre viene proprio presa da uno screenshot di un template di ticket, copiabile da qualunque membro desideri proporre un cambiamento e modificabile una volta copiato a seconda dell'esigenze riportate in precedenza.
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=15cm]{images/template_change_request_asana.pdf}
	...
	\subsection{Gestione delle Infrastrutture}
		...
		\subsubsection{Procedure}
			...
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=15cm]{images/installazione_git_hook.pdf}
			...
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=15cm]{images/installazione_tpl_commit_msg.pdf}
