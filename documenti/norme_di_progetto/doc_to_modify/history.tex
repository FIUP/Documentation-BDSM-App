...
\begin{small}
	...
	\begin{longtable}{p{6cm}|c|c|c}
		...
		% Fase di Progettazione di Detagglio - Requisiti opzionali - RQ





		% Fase di Progettazione di Detagglio - Requisiti desiderbaili





		% Fase di Progettazione di Detagglio - Requisiti obbligatori
		...
		\hline
		\emph{Ampliamento lista di controllo con errori tipici UML e codice in \ref{sec:lista_di_controllo}} &
			\begin{tabular}[c]{c c}
				Roetta Marco \\
		...
		\hline
		\emph{Inserimento strumento per la verifica Cloc in \ref{par:cloc}} &
			\begin{tabular}[c]{c c}
				Roetta Marco \\
				\emph{Amministratore di Progetto} \\
		\end{tabular} & 2015-04-07 & v3.0.5 \\
		\hline
		...
		\hline
		\emph{Inserita appendice Configurazione File Python in \ref{sec:configurazione_file_python}} &
			\begin{tabular}[c]{c c}
				Roetta Marco \\
				\emph{Amministratore di Progetto} \\
		\end{tabular} & 2015-04-06 & v3.0.3 \\
		\hline
		\emph{Inserita appendice Configurazione File AngularJS in \ref{sec:configurazione_file_angularjs}} &
			\begin{tabular}[c]{c c}
				Roetta Marco \\
				\emph{Amministratore di Progetto} \\
