...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} l'utente ha ottenuto tutti i grafici e i dati di tutte le View inerenti alla metrica scelta. selezionata.
\end{itemize}
% FINE USE CASE %
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} l'utente ha visualizzato un messaggio che lo informa che i dati per generare le View non sono ancora stati raccolti dal sistema;
\end{itemize}
% FINE USE CASE %
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} l'utente ha premuto sull'apposito pulsante per generare il confronto e creare le relative View;
	\item \textbf{Postcondizione:} l'utente ha visualizzato un messaggio che lo informa che i dati per generare le View di confronto non sono ancora stati raccolti dal sistema;
\end{itemize}
% FINE USE CASE %
...
\begin{itemize}
	...
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
	\end{itemize}
	\item \textbf{Descrizione:} l'amministratore può inserire il titolo, una breve descrizione ed i parametri per la nuova Recipe nel pannello apposito;
	...
	\begin{enumerate}
		...
		\item Inserimento metrica Facebook (UC1.4.2.3.3);
		\item Inserimento metrica Twitter (UC1.4.2.3.4);
		\item Inserimento metrica Instagram (UC1.4.2.3.5);
	\end{enumerate}
\end{itemize}
% FINE USE CASE %

\subsubsection{UC1.4.2.3.1: Inserimento titolo Recipe}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
	...
	\item \textbf{Precondizione:} [TO DO];
	\item \textbf{Postcondizione:} [TO DO].
\end{itemize}
% FINE USE CASE %

\subsubsection{UC1.4.2.3.3: Inserimento descrizione Recipe}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.4.2.3.3: Inserimento metrica Facebook}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.4.2.3.4: Inserimento metrica Twitter}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.4.2.3.5: Inserimento metrica Instagram}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\begin{itemize}
	...
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
	\end{itemize}
	\item \textbf{Descrizione:} l'amministratore durante l'inserimento di una nuova Recipe ha inserito dei parametri non conformi alle specifiche presenti in UC1.4.2.3;
