...
% =============================================================================================================================
% 2.0.5			2015-03-12			aggiunto UC2.4 e sistemato UC2													Tesser Paolo
% =============================================================================================================================
%
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{enumerate}
		\item Visualizza View della metrica (UC1.3.1.1).
	\end{enumerate}
\end{itemize}
% FINE USE CASE %

\subsubsection{UC1.3.1.X: Visualizza View della metrica}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
	\end{itemize}
	\item \textbf{Descrizione:} premendo sull'apposito pulsante è possibile far comparire a video tutte le View associate alla metrica scelta;
	\item \textbf{Precondizione:} l'utente ha premuto sul pulsante che manda alla visualizzazione;
	\item \textbf{Postcondizione:} l'utente ha ottenuto l'elenco di tutte le View inerenti alla metrica selezionata.
\end{itemize}
% FINE USE CASE %
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{enumerate}
		\item Genera confronto tra metriche per ottenere le View (UC1.3.2.1);
		\item Visualizza confronto View (UC1.3.2.2).
	\end{enumerate}
\end{itemize}
% FINE USE CASE %

\subsubsection{UC1.3.2.1: Genera confronto tra metriche per ottenere le View}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
...
\subsubsection{UC1.3.2.2: Visualizza confronto View}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
