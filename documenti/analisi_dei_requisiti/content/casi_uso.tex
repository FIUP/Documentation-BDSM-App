...
\begin{itemize}
	...
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
	\end{itemize}
	\item \textbf{Descrizione:} l'utente visualizza un elenco di ; 
	\item \textbf{Precondizione:} [TO DO];
	\item \textbf{Postcondizione:} [TO DO];
	\item \textbf{Flusso principale degli eventi:}
	\begin{enumerate}
		\item Visualizza View della parte (UC1.3.1.1).
	\end{enumerate}
\end{itemize}
...
\begin{figure}[htbp]
	...
	\caption{UC2.3 - C2.3: Invalidamento del token di accesso}
\end{figure}
