...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item un utente amministratore può fare tutte le operazioni di un utente autenticato, più ha la possibilità di creare ed eliminare Recipe, visualizzare le richieste di nuove Recipe ed eliminare un utente e tutte le sue View preferite o modificarne i privilegi;
	\end{itemize}
...
\subsubsection{UC1.4.1: Aggiungi nuova Recipe}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.4.1.2: Inserimento parametri}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.4.1.2.2: Inserimento descrizione Recipe}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.4.1.3: Conferma parametri inseriti}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.4.3: Eliminazione Recipe}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.4.3.2: Conferma eliminazione Recipe}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.4.5: Nessuna Recipe in classifica}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
...
\subsubsection{UC1.5.2: Modifica username}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente che ha effettuato l'accesso al servizio;
...
\subsubsection{UC1.5.3.1: Inserimento indirizzo email}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente che ha effettuato l'accesso al servizio;
...
\subsubsection{UC1.5.4: Modifica password}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente che ha effettuato l'accesso al servizio;
...
\subsubsection{UC1.5.4.2: Inserimento nuova password}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente che ha effettuato l'accesso al servizio;
...
\subsubsection{UC1.5.5: Eliminazione account utente}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente che ha effettuato l'accesso al servizio;
...
\subsubsection{UC1.5.5.2: Conferma eliminazione account}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente che ha effettuato l'accesso al servizio;
...
\subsubsection{UC1.5.7:  Errore nell'inserimento dei dati}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente che ha effettuato l'accesso al servizio;
...
\begin{itemize}
	...
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
	\end{itemize}
	\item \textbf{Descrizione:} l’amministratore può visualizzare un messaggio di errore se l’utente che vuole eliminare è attualmente autenticato al sistema e sta eseguendo delle operazioni o in caso stia cercando di modificare i permessi di se stesso;
	\item \textbf{Precondizione:} l'amministratore ha confermato le modifiche apportate;
	\item \textbf{Scenario principale:} l'amministratore visualizza un messaggio contenente gli errori rilevati dal sistema;
...
\begin{itemize}
	...
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
	\end{itemize}
	\item \textbf{Descrizione:} l'amministratore, una volta selezionato il pulsante per la respinta della richiesta, può inserire un messaggio di motivazione per l'utente;
	...
	\item \textbf{Scenario principale:} l'amministratore inserisce il messaggio nell'apposito form;
...
\begin{itemize}
	...
	\item \textbf{Scenario principale:} l'utente visualizza un messaggio che conferma l'invalidamento del token;
