...
\begin{itemize}
	...
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
	\end{itemize}
	\item \textbf{Descrizione:}t l'amministratore può visualizzare l'elenco di tutti gli utenti salvati nel sistema selezionando l'apposito pulsante nella sua home screen;
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} l'amministratore ha effettuate delle modiche nella pagina di elenco utenti;
...
\begin{itemize}
	...
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
	\end{itemize}
	\item \textbf{Descrizione:} l’amministratore può visualizzare un messaggio di errore se l’utente che vuole eliminare è attualmente autenticato al sistema e sta eseguendo delle operazioni o in caso stia cercado di modificare i permessi di sè stesso;
...
\begin{comment}
	...
	\begin{itemize}
		...
		\item \textbf{Scenario principale:} l'utente riceve una segnalazione che la View non è stata aggiunta tra quelle preferite;
		\item \textbf{Postcondizione:} l'utente ha ricevuto le informazioni legate all'impossibilità di aggiungere tale View ai preferiti.
	\end{itemize}
	% FINE USE CASE %
\end{comment}
...
\begin{itemize}
	...
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
	\end{itemize}
	\item \textbf{Descrizione:} l'utente visualizza carica la pagina dei preferiti ma nessuna View risulta marcata come preferita;
	\item \textbf{Precondizione:} l'utente si trova nella pagina dei preferiti e non ha agginto nessuna View ai preferiti;
	\item \textbf{Scenario principale:} l'utente visualizza un messaggio il quale avverte che nessuna View è stata aggiunta ai preferiti;
...
\begin{comment}
	...
	\begin{itemize}
		...
		\item \textbf{Scenario principale:} l'utente riceve una segnalazione che la View non è stata rimossa da quelle preferite;
		\item \textbf{Postcondizione:} l'utente ha ricevuto le informazioni legate all'impossibilità di rimuovere tale View dai preferiti.
	\end{itemize}
	% FINE USE CASE %
\end{comment}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} l'utente desidera avere un nuovo token di accessoDIA
	\item \textbf{Flusso principale degli eventi:}
	\begin{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale:} l'utente visualizza un messaggio contenente gli errori riscontrati;
