...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{enumerate}
		\item Visualizza metriche delle Recipe (UC1.3.1);
		\item Confronta metriche delle Recipe (UC1.3.2).
	\end{enumerate}
...
\subsubsection{UC1.3.1: Visualizza metriche delle Recipe}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} l'utente ha premuto;
...
\subsubsection{UC1.3.2: Confronta metriche delle Recipe}
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{enumerate}
		\item Visualizza confronto View (UC1.3.2.1).
	\end{enumerate}
\end{itemize}


\subsubsection{UC1.3.2.1: Visualizza confronto View}
