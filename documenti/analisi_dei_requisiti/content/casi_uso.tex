...
\begin{itemize}
	...
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
	\end{itemize}
	\item \textbf{Descrizione:} l'utente può modificare le proprie informazioni personali, quali username, email e password;
...
\subsection{UC1.5.2: Modifica username}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
...
\begin{itemize}
	...
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
	\end{itemize}
	\item \textbf{Descrizione:} l'utente può il proprio indirizzo email associato al servizio tramite lapposita sezione;
...
\subsection{UC1.5.3.1: Inserimento indirizzo email}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} l'utente ha effettuato l'accesso al sistema e si trova nella pagina di modifica dettagli utente;
	\item \textbf{Scenario principale:} l'utente inserice  l'indirizzo email di confemra nell'apposito campo;
	\item \textbf{Postcondizione:} il sistema ottiene l'indirizzo email di conferma e controlla in tempo reale se i due indirizzi inseriri sono identici;
\end{itemize}
% FINE USE CASE %

\subsection{UC1.5.4: Modifica password} TO DO
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
...
\subsection{UC1.5.4.1: Inserimento vecchia password} TO DO
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
...
\subsection{UC1.5.4.2: Inserimento nuova password} TO DO
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
...
\subsection{UC1.5.4.3: Conferma nuova password} TO DO
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
