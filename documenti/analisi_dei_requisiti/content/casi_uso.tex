...
\begin{figure}[!htbp]
	\centering
	\centerline{\includegraphics[scale=0.45]{./images/UC1_3.pdf}} % TO CHANGE
...
\begin{itemize}
	...
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
	\end{itemize}
	\item \textbf{Descrizione:} premendo sull'apposito pulsante è possibile far comparire a video l'elenco di tutte le View utente divise per categoria;
...
\subsubsection{UC1.3.2: Aggiungi una View a Home Screen}
...
\subsubsection{UC1.9.2: Inserimento parametri richiesta} TODO
...
\begin{figure}[htbp]
	\centering
	\centerline{\includegraphics{./images/UC2.pdf}} % TO CHANGE
...
\begin{figure}[htbp]
	\centering
	\centerline{\includegraphics {./images/UC2_3.pdf}} % TO CHANGE
