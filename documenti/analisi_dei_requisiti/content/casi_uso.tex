...
\subsubsection{UC 1.3.3: Errroe nella Creazione di nuova View}
...
\item \textbf{Precondizione:} La vista è stata creata ed è disponibile nell'elenco Views dell'utente.
...
\subsubsection{UC 1.3.6.2: conferma eliminazione di una View}
...
\subsubsection{UC 1.4.1: Visualizza Recipe}
...
\subsubsection{UC 1.4.1.1: Apertura elenco Recipe}
...
\subsubsection{UC 1.4.2: Aggiungi una Recipe}
...
\subsubsection{UC 1.4.2.1: Apertura pannello inserimento nuova Recipe}
...
\subsubsection{UC 1.4.3: Errore nell'inserimetno di una Recipe}
