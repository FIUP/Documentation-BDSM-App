...
\begin{itemize}
	...
	\begin{itemize}
		\item utente autenticato: utente autenticato che ha accesso al servizio;
	\end{itemize}
	\item \textbf{Descrizione:} per generare le View di confronto l'utente deve selezionare i parametri;
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Descrizione:} [TO DO];
	\item \textbf{Precondizione:} l'utente ha premuto sull'apposito pulsante per generare il confronto e creare i relativi grafici;
