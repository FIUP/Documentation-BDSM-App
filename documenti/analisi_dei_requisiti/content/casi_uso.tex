...
\begin{itemize}
	...
	\item \textbf{Precondizione:} l'amministratore non ha ancora inserito il titolo della Recipe;
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} l'amministratore non ha ancora inserito la descrizione della Recipe;
	\item \textbf{Postcondizione:} l'amministratore ha inserito una descrizione della Recipe o ha lasciato il campo vuoto.
\end{itemize}
% FINE USE CASE %

\subsubsection{UC1.4.2.3.3: Inserimento metrica}
\begin{itemize}
	\item \textbf{Attori:}
	\begin{itemize}
		\item utente amministratore: utente autenticato che ha accesso al servizio e dispone dei permessi per visualizzare tutte le aree;
	...
	\item \textbf{Precondizione:} l'amministratore non ha ancora inserito una metrica o ne ha già inserita una completamente e ora desidera inserirne un'altra;
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} l'amministratore ha visualizzato un messaggio di errore contenente l'elenco dei parametri inseriti non corretti o un messaggio che dice che manca da inserire almeno una metrica.
\end{itemize}
% FINE USE CASE %
