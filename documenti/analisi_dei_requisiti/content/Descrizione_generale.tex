...
\item Un applicativo server-side che interroga i social network alla ricerca di informazioni fornite come parametri dagli utenti autenticati sull'interfaccia grafica.
\end{itemize}
