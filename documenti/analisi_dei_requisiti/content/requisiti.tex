...
\begin{center}
	...
	\begin{longtable}{| p{2cm} | p{8cm} | p{2cm} |}
		...
		ROV6  &  [TO DO] (sdk usate per chiamate API social)  &  Interno \\
		\hline
		ROV6.1  &  [TO DO] (sdk usate per chiamate API Facebook)  &  Interno \\
		\hline
		ROV6.2  &  [TO DO] (sdk usate per chiamate API Twitter)  &  Interno \\
		\hline
		ROV6.3  &  [TO DO] (sdk usate per chiamate API Instagram)  &  Interno \\
		\hline
