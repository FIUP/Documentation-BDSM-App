...
\begin{center}
	...
	\begin{longtable}{| p{2.5cm} | p{8cm} | p{2cm} |}
		...
		\hline
		ROF3.3.6.3  &  Se i dati inseriti sono corretti viene visualizzato un mesaggio che indica il salvataggio dei cambiamenti  &  UC1.5.5 \\
		...
		\hline
		ROF8.2.1.2  &  Una Recipe è incorretta se l'utente non ha inserito correttamente i parametri citati nel requisito ROF8.1.1.4 &  nterno \\
		\hline
		...
		\hline
		R0F9.2.2  &  Un utente non può essere eliminato se questo è attulmente loggato al sistema  &  Interno \\
		\hline
