...
% =================================================================================================
% 2.0.8			2015-04-02			inseriti requisiti per API offerte						Tesser Paolo
% =================================================================================================
% 3.0.1			2015-05-08			corretto requisito RDV1.3 e diagrammi					Tesser Paolo
% =================================================================================================
%
...
\begin{center}
	...
	\begin{longtable}{| p{2.5cm} | p{8cm} | p{2cm} |}
		...
		\hline
		RDF5.3.1.5  &  Tipo di View: viene visualizzato un Map Chart che illustra le zone nella quale si sono creati degli eventi di una pagina e mostra dei cerchi di diverse dimensioni a seconda della media di partecipanti agli eventi di quella zona. & Interno \\
		\hline
		...
		\hline
		RDF5.4.1.3  &  Tipo di View: viene visualizzato un Map Chart che illustra l'area geografica di appartenenza dei Tweet con un particolare hashtag. & Interno \\
		\hline
		...
		\hline
		ROF5.5.1.1  &  Tipo di View: vengono visualizzati il numero di followers e il numero di post di un utente in un Bar Chart & Interno \\
		\hline
		ROF5.5.1.2  &  Tipo di View: vengono visualizzati i followers di un utente in un Line Chart. Per questo grafico viene fornita una visualizzazione settimanale, mensile e annuale. & Interno \\
		\hline
		ROF5.5.1.3  &  Tipo di View: vengono visualizzati i like e i commenti ricevuti da un utente in un Line Chart. Per questo grafico viene fornita una visualizzazione settimanale, mensile e annuale. & Interno \\
		\hline
		...
		\hline
		ROF5.5.1.7  &  Tipo di View: viene visualizzato in un Line Chart il numero di post che hanno usato un dato hashtag. Per questo grafico viene fornita una visualizzazione settimanale, mensile e annuale. & Interno \\
		\hline
		...
		\hline
		RDF5.5.1.9  &  Tipo di View: vengono visualizzate in un Map Chart le zone geografiche dove sono stati fatti i post contenenti un dato hashtag (di cui è nota la localizzazione). & Interno \\
		\hline
