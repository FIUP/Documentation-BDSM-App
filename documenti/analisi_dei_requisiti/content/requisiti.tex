...
\begin{center}
	...
	\begin{longtable}{| p{2.5cm} | p{8cm} | p{2cm} |}
		...
		\hline
		RFF3.2.2 &  Nel pannello delle statistiche viene mostrato il numero di View preferite &  UC1.2.2.1 \\
		\hline
		...
		\hline
		ROF3.3.1  &  Se l'utente seleziona il pulsante di modifica dettagli personali, il sistema visualizza una pagina tramite cui è possibile modificare il proprio username, indirizzo email e password &  UC1.5 \newline UC1.5.1 \newline UC1.5.2 \newline UC1.5.3 \newline UC1.5.4 \\
		\hline
...
\begin{center}
	...
	\begin{longtable}{| p{2.5cm} | p{8cm} | p{2cm} |}
		...
		\hline
RDV1.4  &  Il sistema sfrutterà Google Cloud Endpoints. & Capitolato \newline Verbale 2015/01/14 \\
		\hline
