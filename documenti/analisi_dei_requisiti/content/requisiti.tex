...
\begin{center}
	...
	\begin{longtable}{| p{2.5cm} | p{8cm} | p{2cm} |}
		...
		\hline
		ROF5.6.4.1  &  Una volta cliccato il pulsante per generare il confronto l'utente deve poter vedere la View di confronto generata dal confornto selezionato  &  UC1.3.2.3 \\
		\hline
		ROF5.6.4.2  &  Se non fossero presenti nel database dati sufficienti per generare la View l'utente deve poter visualizzare un messaggio di avvertimento ed essere riportato alla selezione delle metriche  &  UC1.3.2.4 \\
		\hline
