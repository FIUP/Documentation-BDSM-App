...
\begin{center}
	...
	\begin{longtable}{| p{2cm} | p{8cm} | p{2cm} |}
		...
		\hline
		R0F8.4  &  L'utente amministratore può eliminare una Recipe memorizzata nel sistema tramite il relativo pulsante nella schermata di elenco delle ricette  &  UC1.4.4 \newline 1.4.4.1 \newline UC1.4.4.2 \\
		\hline
