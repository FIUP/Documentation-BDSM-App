...
\begin{center}
	...
	\begin{longtable}{| p{2.5cm} | p{8cm} | p{2cm} |}
		...
		\hline
		ROF3.3.3  &  L'utente può cambiare indirizzo email inserendolo nell'apposito form  &  UC1.5.3 & UC1.5.3.1  \\
		\hline
		ROF3.3.3.1  &  L'utente deve ridigitare l'indirizzo inserito in un form apposito per conferma  &  UC1.5.3 & UC1.5.3.2  \\
		\hline
		...
		\hline
		ROF5.2.2 & Se viene selezionata una metrica di una categoria per la quale il sistema non ha ancora raccolto dati suffcicienti a generare una View, viene visualizzato un messaggio che avverte l'impossibilità a generare alcuna View &  UC1.3.1.4  \\
		\hline
