...
\begin{center}
	...
	\begin{longtable}{| p{2.5cm} | p{8cm} | p{2cm} |}
		...
		\hline
		ROF10.1  &  L'amministratore può vedere l'elenco delle richieste di nuove Recipe.  & UC1.10 \\
		\hline
		ROF10.1.1  &  Per ogni voce dell'elenco deve essere fornito il titolo della Recipe richiesta e la sua descrizione qualora presente.  & Interno \\
		\hline
		...
		\hline
		ROF10.1.3  &  Per ogni voce dell'elenco.  & UC1.10 \\
		\hline
		ROF10.X.X  &  [TO DO].  & UC1.10 \\
		\hline
		ROF10.X.X  &  [TO DO].  & UC1.10 \\
		\hline
		ROF10.X.X  &  [TO DO].  & UC1.10 \\
