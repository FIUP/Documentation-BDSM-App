...
\begin{center}
	...
	\begin{longtable}{| p{2cm} | p{8cm} | p{2cm} |}
		...
		\hline
		ROF5.3.1.1  & Tipo di View: viene visualizzato un Line Chart con due linee per vedere l'andamento & Interno \\
		\hline	
		ROF5.3.1.2  &  Tipo di View: [TO DO] & Interno \\
		\hline
		ROF5.3.1.3  &  Tipo di View: [TO DO] & Interno \\
		\hline
		ROF5.3.1.4  &  Tipo di View: [TO DO] & Interno \\
		\hline
		ROF5.3.1.5  &  Tipo di View: [TO DO] & Interno \\
		\hline
